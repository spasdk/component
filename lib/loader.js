...
module.exports = {
    load: function ( prefix ) {
        var files = [
                path.join('node_modules', 'spa-component', 'sass', 'vars', 'default.scss'),
                path.join('node_modules', 'spa-component', 'sass', 'main')
            ],
        ...
        names.forEach(function ( name ) {
            ...
            if ( name.indexOf(prefix) !== -1 ) {
                ...
                files.push(path.join('node_modules', name, 'sass', 'vars', 'default.scss'));
                files.push(path.join('node_modules', name, 'sass', 'main.scss'));
            }
        });
